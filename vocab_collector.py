...
prompt = """"List the interesting words from the text from user_input
    ...
    - "Synonyms" - give at least 3 synonyms in English related to each interesting word and the output type is string
    - "Example" - the example of using each interesting word"""    


st.title('Vocab Collector')
st.markdown('Input the text that you want to learn vocabularies. \n\
            The AI will give you the vocabularies you should know.')
